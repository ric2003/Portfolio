        ...
        <div className="max-w-4xl mx-auto left-1/2">
          ...
          <div className="space-y-12">
            ...
            <div className={`transition-all duration-1000 delay-200 ${aboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <h3 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 my-6 mt-10">{t('about.tech_stack_title')}</h3>
              ...
              <div className="mt-10 flex flex-wrap gap-3 ">
                {techStack.map((tech, index) => (
                  <span key={index} className={`flex items-center px-4 py-2 font-bold rounded-lg bg-neutral-900 dark:bg-neutral-100 text-neutral-100 dark:text-neutral-900 text-sm shadow`}>
                    {tech.comingSoon && <span className="text-xs text-neutral-100 dark:text-neutral-900 bg-neutral-900 dark:bg-neutral-100 border border-neutral-900 dark:border-neutral-900 rounded-full px-2 py-1 mr-2">{t('about.coming_soon')}</span>}
                    {tech.name}
                  </span>
                ))}
              </div>
